...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.rectangle(current_frame, (x, y), (x + w, y + h), (0, 255, 255), 3)  # Parameters: frame, top-left coordinates, bottom-right coordinates, box color, thickness

        # Utilize the recognizer.predict() method to obtain the predicted label (id) and confidence score for the facial region
